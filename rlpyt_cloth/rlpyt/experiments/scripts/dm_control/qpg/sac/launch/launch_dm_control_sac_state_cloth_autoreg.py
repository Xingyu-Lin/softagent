...
experiment_title = "sac_dm_control_state_cloth_autoreg"
variant_levels = list()
...
model_cls = ['GumbelAutoregPiMlpModel', 'AutoregPiMlpModel'] #['PiMlpModel', 'GumbelPiMlpModel']
random_location = [False, False] #[True, False]
sac_module = ['sac_v2_generic', 'sac_v2'] #['sac_v2', 'sac_v2_generic']
sac_agent_module = ['sac_agent_autoreg_v2_generic', 'sac_agent_autoreg_v2'] #['sac_agent_v2', 'sac_agent_v2_generic']
