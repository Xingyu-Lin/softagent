...
def main(mode, debug, dry):
    exp_prefix = '0721_cloth_drop_rgb'
    reward_scales = {
        'PourWater': 20.0,
        'PassWaterTorus': 20.0,
        'PassWater': 20.0,
    ...
    vg.add('env_name', ['RigidClothDrop', 'ClothDrop'])
    ...
    vg.add('critic_lr', lambda env_kwargs_observation_mode: [3e-4] if env_kwargs_observation_mode == 'cam_rgb' else [5e-4])
